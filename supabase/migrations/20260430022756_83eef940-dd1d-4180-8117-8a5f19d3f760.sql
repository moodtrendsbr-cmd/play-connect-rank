  ...
  BEGIN
    FOR r IN
      ...
      SELECT athlete_id, position, total_points,
        ...
        FROM ranked
       WHERE position > 1 AND (next_points - total_points) BETWEEN 1 AND 30
       LIMIT 50
    LOOP
  ...
  BEGIN
    FOR r IN
      ...
      SELECT a.arena_id, a.tenant_id, a.owner_user_id
        FROM a WHERE a.avg3d > 0 AND a.recent::numeric > a.avg3d * 1.5
       LIMIT 50
    LOOP
      PERFORM public.orkym_trigger_enqueue(
